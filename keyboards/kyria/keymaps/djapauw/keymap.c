...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MEDIA] = LAYOUT(
            ...
            MO(_MULTIKEY), _______, _______, _______, _______, _______, _______, _______, _______, _______
            ),
/*
     * Lower Layer: Numeric
     *
 ...
 */
    [_MULTIKEY] = LAYOUT(
      ...
      KeyShift, KeyA  , KeyR   , KeyS   , KeyT   , KeyD   ,                                     _______, _______, _______, _______, _______, _______,
